...
HOW TO USE:
    From the PhotoMosaic_source/ directory, run:
...
MODERNIZATION NOTES:
    ...
    - Compatible with current project layout (color_metrics/ as a subfolder).
...
ext_modules = [
    ...
    Extension("color_metrics", [
        "color_metrics/color_metrics.pyx",
        "color_metrics/deltaE2000.c",
        "color_metrics/rgb2lab.c"
    ],
    include_dirs=[numpy.get_include(), "."],
    library_dirs=[],
    libraries=[]),
